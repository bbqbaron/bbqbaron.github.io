...
Elm.Astar.make = function (_elm) {
   ...
   if (_elm.Astar.values)
   return _elm.Astar.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
      ...
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 ...
                 {case "_Tuple2":
                    return function () {
                         var dist = $List.sum($List.map($Basics.abs)(_L.fromArray([_v0._0 - _v1._0
                                                                                  ,_v0._1 - _v1._1])));
                         return {ctor: "_Tuple2"
                                ,_0: dist
                                ,_1: {ctor: "_Tuple2"
            ...
            return function () {
                 ...
                 {case "_Tuple2":
                    return {ctor: "_Tuple2"
                           ...
                           ,_1: _v8._1 + _v9._1};}
                 _U.badCase($moduleName,
                 "on line 27, column 28 to 38");
              }();}
         _U.badCase($moduleName,
         "on line 27, column 28 to 38");
      }();
   });
   var prioritize = F2(function (grid,
   p) {
      return function () {
         var priority = $Maybe.withDefault(0)($Maybe.map(function (_v16) {
            return function () {
               ...
               _v16.item)) + A2($Maybe.withDefault,
               0,
               A2($Maybe.map,
               function ($) {
   ...
   var seek = F2(function (grid,
   _v18) {
      return function () {
         switch (_v18.ctor)
         {case "_Tuple2":
            return function () {
                 var hasAnything = F2(function (_v22,
                 _v23) {
                    return function () {
                       return function () {
                          return !_U.eq(_v23.item,
                          $Maybe.Nothing);
                       }();
                    }();
                 });
                 var pointsOfInterest = A2($Dict.filter,
                 hasAnything,
                 grid);
                 var byDistance = $List.sortBy($Basics.fst)($List.map(distance({ctor: "_Tuple2"
                                                                               ,_0: _v18._0
                                                                               ,_1: _v18._1}))($Dict.keys(pointsOfInterest)));
                 var shortestDistance = $Basics.fst($Maybe.withDefault({ctor: "_Tuple2"
                                                                       ,_0: 0
                                                                       ,_1: {ctor: "_Tuple2"
                                                                            ,_0: 0
                                                                            ,_1: 0}})($List.head(byDistance)));
                 var closest = A2($List.filter,
                 function ($) {
                    return F2(function (x,y) {
                       return _U.eq(x,y);
                    })(shortestDistance)($Basics.fst($));
                 },
                 byDistance);
                 var prioritized = $List.map($Basics.snd)($List.reverse($List.sortBy($Basics.fst)($List.map(prioritize(pointsOfInterest))($List.map($Basics.snd)(closest)))));
                 return $Maybe.withDefault({ctor: "_Tuple2"
                                           ,_0: _v18._0
                                           ,_1: _v18._1})($List.head(prioritized));
              }();}
         _U.badCase($moduleName,
         "between lines 52 and 68");
      }();
   });
   var pickDir = F2(function (grid,
   _v26) {
      return function () {
         switch (_v26.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 x$ = $._1;
                 var $ = _U.cmp(y$,
                 _v26._0) > 0 ? {ctor: "_Tuple2"
                                ,_0: 1
                                ,_1: 0} : _U.cmp(y$,
                 _v26._0) < 0 ? {ctor: "_Tuple2"
                                ,_0: -1
                                ,_1: 0} : _U.cmp(x$,
                 _v26._1) > 0 ? {ctor: "_Tuple2"
                                ,_0: 0
                                ,_1: 1} : _U.cmp(x$,
                 _v26._1) < 0 ? {ctor: "_Tuple2"
                                ,_0: 0
                 ...
                 y$$ = $._0,
                 x$$ = $._1;
                 return $Util.bound(A2(movePoint,
                 {ctor: "_Tuple2"
                 ,_0: _v26._0
                 ,_1: _v26._1},
                 {ctor: "_Tuple2"
...
Elm.Const.make = function (_elm) {
   ...
   if (_elm.Const.values)
   return _elm.Const.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm),
   $Types = Elm.Types.make(_elm);
   var classes = _L.fromArray([{_: {}
                               ,abilities: _L.fromArray([])
                               ,name: "Cleric"}
                              ,{_: {}
                               ,abilities: _L.fromArray([])
                               ,name: "Warlock"}
                              ...
                              ,{_: {}
                               ...
                               ,name: "Shaman"}
                              ,{_: {}
                               ,abilities: _L.fromArray([$Types.Tough])
                               ,name: "Crusader"}
                              ,{_: {}
                               ,abilities: _L.fromArray([])
                               ,name: "Alchemist"}
   ...
   var numberOfItems = 5;
   var width = 8;
   var xRange = _L.range(0,
   width - 1);
   var height = 8;
   var yRange = _L.range(0,
   height - 1);
   var tileSize = 75;
   _elm.Const.values = {_op: _op
                       ,tileSize: tileSize
                       ,height: height
                       ,width: width
                       ,yRange: yRange
...
Elm.Generators = Elm.Generators || {};
Elm.Generators.make = function (_elm) {
   "use strict";
   _elm.Generators = _elm.Generators || {};
   if (_elm.Generators.values)
   return _elm.Generators.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Types = Elm.Types.make(_elm);
   var addRandom = F4(function (genFn,
   addFn,
   howMany,
   model) {
      return function () {
         ...
         F2(function (_v0,_v1) {
            return function () {
               ...
               _U.badCase($moduleName,
               "on line 74, column 41 to 50");
            }();
         }),
         {ctor: "_Tuple2"
         ,_0: _L.fromArray([])
         ,_1: seed},
         _L.range(0,howMany - 1)),
         specs = $._0,
         s$ = $._1;
         var grid = model.grid;
         var grid$ = A3($List.foldl,
         F2(function (_v6,g$) {
            return function () {
               switch (_v6.ctor)
               {case "_Tuple2":
   ...
   var inserter = F3(function (inserter,
   value,
   square) {
      return A2($Maybe.map,
      function (s) {
         return A2(inserter,value,s);
      },
      square);
   });
   var addItem = inserter(F2(function (value,
   square) {
      return _U.replace([["item"
                         ,$Maybe.Just({_: {}
                                      ,name: "I"
                                      ,value: value})]],
      square);
   }));
   var addMonster = inserter(F2(function (hp,
   square) {
      return _U.replace([["monster"
                         ,$Maybe.Just({_: {}
                                      ,cooldown: 4
                                      ,currentCooldown: 0
                                      ,currentHP: hp
   ...
   var addPC = inserter(F2(function ($class,
   square) {
      return _U.replace([["pcs"
                         ,A2($List._op["::"],
                         {_: {}
                         ,$class: $class
                         ,name: "PC"
                         ,statuses: _L.fromArray([])
                         ,xp: 0},
                         square.pcs)]],
      square);
   }));
   var classNumGenerator = A2($Random.$int,
   0,
   $List.length($Const.classes) - 1);
   var classGenerator = $Random.customGenerator(function (seed) {
      return function () {
         ...
         idx = $._0,
         s$ = $._1;
         var $class = $Maybe.withDefault({_: {}
                                         ,abilities: _L.fromArray([])
                                         ,name: "???"})($List.head(A2($List.drop,
         idx,
         $Const.classes)));
         return {ctor: "_Tuple2"
                ,_0: $class
   ...
   var valueGenerator = A2($Random.$int,
   1,
   $Const.maxItemValue);
   var hpGenerator = A2($Random.$int,
   1,
   $Const.maxMonsterHp);
   var pointGenerator = A2($Random.pair,
   A2($Random.$int,
   0,
   $Const.height - 1),
   A2($Random.$int,
   0,
   $Const.width - 1));
   var generateWith = F3(function (gen,
   list,
   seed) {
      return function () {
         var $ = A2($Random.generate,
   ...
   var generateItem = generateWith(valueGenerator);
   var addItems = A3(addRandom,
   generateItem,
   addItem,
   $Const.numberOfItems);
   var generateMonster = generateWith(hpGenerator);
   var addMonsters = A3(addRandom,
   generateMonster,
   addMonster,
   $Const.numberOfMonsters);
   var generatePC = generateWith(classGenerator);
   var addPCs = A3(addRandom,
   generatePC,
   addPC,
   $Const.numberOfPCs);
   var startTimeSeed = A2($Signal._op["<~"],
   function ($) {
      return $Random.initialSeed($Basics.round($));
   },
   $Signal$Time.startTime);
   _elm.Generators.values = {_op: _op
                            ,startTimeSeed: startTimeSeed
                            ,pointGenerator: pointGenerator
                            ,hpGenerator: hpGenerator
                            ,valueGenerator: valueGenerator
                            ,classNumGenerator: classNumGenerator
...
Elm.Grid.make = function (_elm) {
   ...
   $Types = Elm.Types.make(_elm),
   $Util = Elm.Util.make(_elm);
   var maybeEndGame = function (model) {
      return function () {
         var noItems = $Basics.not($List.any(function ($) {
            return F2(function (x,y) {
               return !_U.eq(x,y);
            })($Maybe.Nothing)(function (_) {
               return _.item;
            }($));
         })($Dict.values(model.grid)));
         return A3($Util.cond,
         noItems,
         function () {
            var player = model.player;
            var player$ = _U.replace([["alive"
                                      ,false]],
            player);
   ...
   var tickCooldowns = function (model) {
      return function () {
         var tickMonster = function (monster) {
            return _U.replace([["currentCooldown"
                               ,A2($Basics.max,
                               0,
                               monster.currentCooldown - 1)]],
            monster);
         };
         return _U.replace([["grid"
                            ,A2($Dict.map,
                            F2(function (_v0,square) {
                               return function () {
                                  return _U.replace([["monster"
                                                     ,A2($Maybe.map,
                                                     tickMonster,
   ...
   var triggerMonsterAOOOn = F3(function (grid,
   _v4,
   _v5) {
      return function () {
         switch (_v5.ctor)
         {case "_Tuple2":
            return function () {
                 switch (_v4.ctor)
                 {case "_Tuple2":
                    return _U.eq(_v5._1.currentCooldown,
                      0) ? function () {
                         var monster$ = _U.replace([["currentCooldown"
                                                    ,_v5._1.cooldown]],
                         _v5._1);
                         var statuses$ = A2($Basics._op["++"],
                         _v4._1.statuses,
                         _L.fromArray([{_: {}
                                       ,duration: A3($Util.cond,
                                       isTough(_v4._1),
                                       2,
                                       3)
                                       ,statusType: $Types.Stun}]));
                         var pc$ = _U.replace([["statuses"
                                               ,statuses$]],
                         _v4._1);
                         return A2($Dict.update,
                         _v5._0,
                         $Maybe.map(function (s) {
                            return _U.replace([["monster"
                                               ,$Maybe.Just(monster$)]],
                            s);
                         }))(A2($Dict.update,
                 ...
                 _U.badCase($moduleName,
                 "between lines 180 and 191");
              }();}
         _U.badCase($moduleName,
         "between lines 180 and 191");
      }();
   });
   var getPCPoints = function (grid) {
      return $Dict.keys($Dict.filter(F2(function (_v12,
      _v13) {
         return function () {
            return function () {
               return !_U.eq(_v13.pcs,
               _L.fromArray([]));
            }();
         }();
      }))(grid));
   };
   var getNeighbors = function (_v16) {
      return function () {
         switch (_v16.ctor)
         {case "_Tuple2":
            return function () {
                 var dirs = _L.fromArray([{ctor: "_Tuple2"
                                          ,_0: -1
                                          ,_1: 0}
   ...
   var getMonstersNextTo = F2(function (grid,
   p) {
      return function () {
         var neighbors = $List.filter($Util.inBounds)(getNeighbors(p));
         return $List.filterMap(function (_v24) {
            return function () {
               switch (_v24.ctor)
               {case "_Tuple2":
                  return A3($Util.cond,
                    ...
                    $Maybe.Nothing);}
               _U.badCase($moduleName,
               "on line 167, column 13 to 74");
            }();
         })($Dict.toList(grid));
      }();
   });
   var squashPlayer = function (model) {
      return function () {
         var player = model.player;
         var pos = player.position;
         var square = $Maybe.withDefault($Types.emptySquare)(A2($Dict.get,
         pos,
         model.grid));
         var hasPC = !_U.eq(square.pcs,
         _L.fromArray([]));
         var player$ = A3($Util.cond,
         hasPC,
         _U.replace([["alive",false]],
         player),
         player);
         return _U.replace([["player"
                            ,player$]],
   ...
   var tick = function (model) {
      return function () {
         var decStun = function (stun) {
            return _U.cmp(stun.duration,
            1) > 0 ? $Maybe.Just(_U.replace([["duration"
                                             ,stun.duration - 1]],
            stun)) : $Maybe.Nothing;
         };
         var tickStun = function (pc) {
            return function () {
               var nonstuns = A2($List.filter,
               function ($) {
                  return $Basics.not($Util.isStun($));
               },
               pc.statuses);
               var stuns = A2($List.filter,
               $Util.isStun,
               pc.statuses);
               var stuns$ = A2($List.filterMap,
               decStun,
               stuns);
               return _U.replace([["statuses"
                                  ,A2($Basics._op["++"],
                                  nonstuns,
                                  stuns$)]],
               pc);
         ...
         var tick = F2(function (p,s) {
            return _U.replace([["pcs"
                               ,A2($List.map,tickStun,s.pcs)]],
            s);
         });
         var grid = model.grid;
         var grid$ = A2($Dict.map,
         tick,
         grid);
         return _U.replace([["grid"
                            ,grid$]],
   ...
   var calculatePoints = function (model) {
      return function () {
         var player = model.player;
         var accPoints = F2(function (_v28,
         points) {
            return function () {
               return function () {
                  var $new = $Maybe.withDefault(0)(A2($Maybe.map,
                  function (_) {
                     return _.value;
                  },
                  _v28.item));
         ...
         var grid = model.grid;
         var points = A2($List.foldl,
         accPoints,
         model.player.points)($Dict.values(grid));
         var points$ = points + $Maybe.withDefault(0)(A2($Maybe.map,
         function (_) {
            return _.value;
         },
         player.carrying));
         var player$ = _U.replace([["points"
                                   ,points$]],
         player);
         return _U.replace([["player"
                            ,player$]],
   ...
   var damageMonster = function (monster) {
      return function () {
         var hp$ = monster.currentHP - 1;
         return A3($Util.cond,
         _U.cmp(hp$,0) > 0,
         $Maybe.Just(_U.replace([["currentHP"
                                 ,hp$]],
         monster)),
         $Maybe.Nothing);
      }();
   };
   var resolveCollisionAt = F2(function (_v30,
   square) {
      return function () {
         return function () {
            var resolve$ = F2(function (pc,
            square) {
               return function () {
                  var value = $Maybe.withDefault(0)(A2($Maybe.map,
                  function (_) {
                     return _.value;
                  },
                  square.item));
                  var monster$ = A2($Maybe.andThen,
                  square.monster,
                  damageMonster);
                  var getXp = !_U.eq(square.item,
                  $Maybe.Nothing) || !_U.eq(square.monster,
                  $Maybe.Nothing) && _U.eq(monster$,
                  $Maybe.Nothing);
                  var xp$ = pc.xp + A3($Util.cond,
                  getXp,
                  value,
                  0);
                  var pc$ = _U.replace([["xp"
                                        ,xp$]],
                  pc);
   ...
   var resolveCollisions = function (model) {
      return function () {
         var grid = model.grid;
         return _U.replace([["grid"
                            ,A2($Dict.map,
   ...
   var movePCFrom = F3(function (_v34,
   pc,
   grid) {
      return function () {
         switch (_v34.ctor)
         {case "_Tuple2":
            return A3($Util.cond,
              ...
              grid,
              function () {
                 var grid$ = A3($Dict.update,
                 {ctor: "_Tuple2"
                 ,_0: _v34._0
                 ,_1: _v34._1},
                 $Maybe.map(removePC(pc)),
                 grid);
                 var stuck = $Maybe.withDefault(false)($Maybe.map(function ($) {
                    return F2(function (x,y) {
                       return !_U.eq(x,y);
                    })($Maybe.Nothing)(function (_) {
                       return _.monster;
                 ...
                 ,_1: _v34._1},
                 grid)));
                 var dest = A2($Util.cond,
                 stuck,
                 {ctor: "_Tuple2"
                 ,_0: _v34._0
                 ,_1: _v34._1})(A2($Astar.pickDir,
                 grid,
                 {ctor: "_Tuple2"
                 ,_0: _v34._0
                 ,_1: _v34._1}));
   ...
   var movePCsFrom = F2(function (_v38,
   grid) {
      return function () {
         switch (_v38.ctor)
         {case "_Tuple2":
            return A3($List.foldl,
              ...
              _v38._1.pcs);}
         _U.badCase($moduleName,
         "on line 73, column 5 to 45");
      }();
   });
   var movePCs = function (model) {
      return function () {
         var grid = model.grid;
         var grid$ = A3($List.foldl,
         movePCsFrom,
   ...
   var triggerAOOsOnPC = F4(function (point,
   square,
   grid,
   pc) {
      return A3($Util.cond,
      ...
      grid,
      function () {
         var monsters = $List.filter(function ($) {
            return F2(function (x,y) {
               return _U.eq(x,y);
            })(0)(function (_) {
               return _.currentCooldown;
            }($Basics.snd($)));
         })(A2(getMonstersNextTo,
         grid,
         point));
         return $Maybe.withDefault(grid)($Maybe.map(A2(triggerMonsterAOOOn,
         grid,
         {ctor: "_Tuple2"
         ,_0: point
         ,_1: pc}))($List.head(monsters)));
      }());
   });
   var triggerAOOsAt = F2(function (_v42,
   grid) {
      return function () {
         switch (_v42.ctor)
         {case "_Tuple2":
            return $Maybe.withDefault(grid)($Maybe.map(A3(triggerAOOsOnPC,
              _v42._0,
              _v42._1,
              grid))($List.head(_v42._1.pcs)));}
         _U.badCase($moduleName,
         "between lines 208 and 211");
      }();
   });
   var processAOOs = function (model) {
      return _U.replace([["grid"
                         ,A3($List.foldl,
                         triggerAOOsAt,
                         model.grid,
   ...
   var swapItems = function (model) {
      return function () {
         var grid = model.grid;
         var player = model.player;
         var position = player.position;
         var item = A2($Maybe.andThen,
         A2($Dict.get,position,grid),
         function (_) {
            return _.item;
         });
         var carrying = player.carrying;
         var grid$ = A3($Dict.update,
         position,
         addItem(carrying),
         grid);
         var player$ = _U.replace([["carrying"
                                   ,item]],
         player);
         return _U.replace([["player"
                            ,player$]
   ...
   var dirsToAction = function (_v47) {
      return function () {
         return _U.eq(_v47.x,
         -1) ? $Types.Move($Types.Left) : _U.eq(_v47.x,
         1) ? $Types.Move($Types.Right) : _U.eq(_v47.y,
         -1) ? $Types.Move($Types.Down) : _U.eq(_v47.y,
         1) ? $Types.Move($Types.Up) : $Types.Idle;
      }();
   };
   _elm.Grid.values = {_op: _op
                      ,dirsToAction: dirsToAction
                      ...
                      ,removePC: removePC
                      ,addPC: addPC
                      ,movePCFrom: movePCFrom
                      ,movePCsFrom: movePCsFrom
                      ,movePCs: movePCs
                      ,damageMonster: damageMonster
                      ,resolveCollisionAt: resolveCollisionAt
                      ,resolveCollisions: resolveCollisions
                      ,calculatePoints: calculatePoints
                      ,tick: tick
                      ,squashPlayer: squashPlayer
                      ,getNeighbors: getNeighbors
                      ,getMonstersNextTo: getMonstersNextTo
                      ,getPCPoints: getPCPoints
                      ,isTough: isTough
                      ,triggerMonsterAOOOn: triggerMonsterAOOOn
                      ,triggerAOOsOnPC: triggerAOOsOnPC
                      ,triggerAOOsAt: triggerAOOsAt
                      ,processAOOs: processAOOs
                      ,tickCooldowns: tickCooldowns
                      ,maybeEndGame: maybeEndGame};
   return _elm.Grid.values;
};
Elm.Html = Elm.Html || {};
...
Elm.Keepaway = Elm.Keepaway || {};
Elm.Keepaway.make = function (_elm) {
   "use strict";
   _elm.Keepaway = _elm.Keepaway || {};
   if (_elm.Keepaway.values)
   return _elm.Keepaway.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Const = Elm.Const.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   $Generators = Elm.Generators.make(_elm),
   ...
   $Types = Elm.Types.make(_elm),
   $Util = Elm.Util.make(_elm);
   var onRelease = F2(function (a,
   k) {
      return $Signal.map($Maybe.withDefault($Types.Idle))(A2($Signal.foldp,
      F2(function (n,o) {
         return _U.eq(o,
         $Maybe.Just($Types.Idle)) && $Basics.not(n) ? $Maybe.Just(a) : $Maybe.Just($Types.Idle);
      }),
      $Maybe.Nothing)(k));
   });
   ...
   var init = function (_v0) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
            return $Grid.resolveCollisions($Generators.addPCs($Generators.addMonsters($Generators.addItems({_: {}
                                                                                                           ,grid: A3($List.foldl,
                                                                                                           F2(function (y,
                                                                                                           g) {
                                                                                                              return A3($List.foldl,
   ...
   model) {
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 var silentModel = _U.replace([["soundToPlay"
                                               ,""]],
                 model);
                 var actionedModel = function () {
                    switch (_v4._0.ctor)
                    {case "Fetch":
                       return $Grid.swapItems(silentModel);
                       case "Move":
                       return function () {
                            var tickedModel = $Grid.tick(silentModel);
                            var $ = $Grid.dirToPoint(_v4._0._0),
                            y$ = $._0,
                            x$ = $._1;
                            var player = silentModel.player;
                            var $ = player.position,
                            y = $._0,
                            x = $._1;
                            var player$ = _U.replace([["position"
                                                      ,$Util.bound({ctor: "_Tuple2"
                                                                   ,_0: y + y$
                                                                   ,_1: x + x$})]],
                            player);
                            return $Grid.maybeEndGame($Grid.squashPlayer($Grid.calculatePoints($Grid.tickCooldowns($Grid.processAOOs($Grid.resolveCollisions($Grid.movePCs(_U.replace([["player"
                                                                                                                                                                                       ,player$]],
                            tickedModel))))))));
                         }();
                       case "Restart":
                       return A3($Util.cond,
                         silentModel.player.alive,
                         silentModel,
                         start(init({ctor: "_Tuple2"
                                    ,_0: {ctor: "_Tuple0"}
                                    ,_1: silentModel.seed})));}
                    return silentModel;
                 }();
                 return actionedModel;
              }();}
         _U.badCase($moduleName,
         "between lines 55 and 76");
      }();
   });
   var updates = $Signal.mailbox($Types.Idle);
   var state = A2($Signal$Extra.foldp$,
   step,
   init)(A2($Signal._op["~"],
   A2($Signal._op["<~"],
   F2(function (v0,v1) {
   ...
   $Signal.mergeMany(_L.fromArray([updates.signal
                                  ,A3($Signal.filter,
                                  F2(function (x,y) {
                                     return !_U.eq(x,y);
                                  })($Types.Idle),
                                  ...
                                  $Grid.dirsToAction,
                                  $Keyboard.arrows))
                                  ,onRelease($Types.Fetch)($Keyboard.space)
                                  ,onRelease($Types.Restart)($Keyboard.isDown(82))]))),
   $Generators.startTimeSeed));
   ...
   A2($Signal._op["<~"],
   function (_) {
      return _.soundToPlay;
   },
   state));
   var main = A2($Signal._op["<~"],
   $Render.render,
   state);
   _elm.Keepaway.values = {_op: _op
                          ,updates: updates
                          ,init: init
                          ,start: start
                          ,step: step
...
Elm.Render.make = function (_elm) {
   ...
   $Types = Elm.Types.make(_elm),
   $Util = Elm.Util.make(_elm);
   var renderRules = $Html.div(_L.fromArray([]))($List.map(function (s) {
      return A2($Html.p,
      _L.fromArray([]),
      _L.fromArray([s]));
   })($List.map(function (t) {
      ...
      _L.fromArray([$Html.text(t)]));
                   ...
                   ,"Press R to begin."]))));
   var renderPoints = function (model) {
      return function (s) {
         return A2($Html.span,
         _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                            ,_0: "color"
      ...
      "Points: ",
      $Basics.toString(model.player.points)));
   };
   var addForm = F2(function (f,
   l) {
      return A2($Basics._op["++"],
      l,
      _L.fromArray([f]));
   });
   var renderHP = F2(function (currentHP,
   maxHP) {
      return function () {
         var current = $Graphics$Collage.moveX(($Const.tileSize - $Const.tileSize * $Basics.toFloat(currentHP) / $Basics.toFloat(maxHP)) * -0.5)($Graphics$Collage.filled($Color.green)(A2($Graphics$Collage.rect,
         $Const.tileSize * $Basics.toFloat(currentHP) / $Basics.toFloat(maxHP),
         $Const.tileSize / 5)));
         var max = $Graphics$Collage.filled($Color.red)(A2($Graphics$Collage.rect,
         $Const.tileSize,
         $Const.tileSize / 5));
         return $Graphics$Collage.moveY($Const.tileSize * -0.3)($Graphics$Collage.group(_L.fromArray([max
                                                                                                     ,current])));
      }();
   });
   var getImage = function (name) {
      ...
      $Const.tileSize,
      $Const.tileSize)(A2($Basics._op["++"],
      "assets/art/",
      A2($Basics._op["++"],
      name,
      ".png"))));
   };
   var renderPC = function (pc) {
      return function () {
         var renderStun = function (stun) {
            return $Graphics$Collage.text($Text.fromString($Basics.toString(stun.duration)));
         };
         var base = getImage(pc.$class.name);
         return $Maybe.withDefault(base)($Maybe.map(function ($) {
            return $Graphics$Collage.group($List.reverse(A2($Basics.flip,
            F2(function (x,y) {
               return A2($List._op["::"],
               x,
               y);
            ...
            _L.fromArray([base]))($)));
         })($Maybe.map(renderStun)($List.head($List.reverse($List.sortBy(function (_) {
            return _.duration;
         })(A2($List.filter,
         $Util.isStun,
         pc.statuses)))))));
   ...
   var renderMonster = function (monster) {
      return function () {
         var cooldown = monster.currentCooldown;
         var base = _L.fromArray([getImage("Goblin")
                                 ,A2(renderHP,
                                 monster.currentHP,
                                 monster.maxHP)]);
         return $Graphics$Collage.group(A3($Util.cond,
         _U.cmp(cooldown,0) > 0,
         A2($Basics._op["++"],
         base,
         _L.fromArray([$Graphics$Collage.text($Text.fromString($Basics.toString(cooldown)))])),
         base));
      }();
   };
   var renderItem = function (_v0) {
      return function () {
         return $Graphics$Collage.group(_L.fromArray([getImage("Gold")
                                                     ,$Graphics$Collage.text($Text.fromString($Basics.toString(_v0.value)))]));
      }();
   };
   var toPos = F2(function (y,x) {
      return function () {
         var $ = $Util.origin,
         oY = $._0,
         oX = $._1;
         return {ctor: "_Tuple2"
                ,_0: oY - $Basics.toFloat(y * $Const.tileSize)
                ,_1: oX + $Basics.toFloat(x * $Const.tileSize)};
      }();
   });
   var renderPlayer = function (_v2) {
      return function () {
         return function () {
            var base = getImage("Imp");
            var withText = $Maybe.withDefault(base)($Maybe.map(function (i) {
               return $Graphics$Collage.group(_L.fromArray([base
                                                           ,$Graphics$Collage.text($Text.fromString($Basics.toString(i.value)))]));
            })(_v2.carrying));
            var $ = _v2.position,
            y = $._0,
            x = $._1;
            return $Graphics$Collage.move(A2(toPos,
            y,
            x))(withText);
         }();
      }();
   };
   var renderSquare = F3(function (y,
   x,
   _v4) {
      return function () {
         return function () {
            var base = A2($Basics._op["++"],
            _L.fromArray([getImage("Ground")]),
            A2($List.map,renderPC,_v4.pcs));
            var base$ = $Maybe.withDefault(base)($Maybe.map(function (r) {
               return A2($Basics._op["++"],
               base,
               _L.fromArray([r]));
            })(A2($Maybe.map,
            ...
            return $Graphics$Collage.move(A2(toPos,
            y,
            x))($Graphics$Collage.group(base$$));
         }();
      }();
   });
   var renderRow = F2(function (y,
   g) {
      return A2($List.map,
      function (x) {
         return A2(renderSquare,
         y,
         x)($Maybe.withDefault($Types.emptySquare)(A2($Dict.get,
         {ctor: "_Tuple2",_0: y,_1: x},
         g)));
      },
      $Const.xRange);
   });
   var renderGrid = function (_v6) {
      return function () {
         return A2($Graphics$Collage.collage,
         $Const.height * $Const.tileSize,
         $Const.width * $Const.tileSize)(addForm(renderPlayer(_v6.player))($Util.flatten(A2($List.map,
         function (y) {
            return A2(renderRow,
            y,
            _v6.grid);
   ...
   var render = function (model) {
      return $Html.div(_L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                         ...
                                                                         ,{ctor: "_Tuple2"
                                                                          ,_0: "height"
                                                                          ,_1: "100%"}]))]))(A2($Basics.flip,
      F2(function (x,y) {
         return A2($List._op["::"],
         x,
         y);
      }),
      _L.fromArray([]))(model.player.alive ? A2($Html.div,
      _L.fromArray([]),
      _L.fromArray([$Html.fromElement(renderGrid(model))
                   ,renderPoints(model)])) : renderRules));
   };
...
Elm.Types.make = function (_elm) {
   ...
   var Stun = {ctor: "Stun"};
   var Class = F2(function (a,b) {
      return {_: {}
             ,abilities: a
             ,name: b};
   });
   var Tough = {ctor: "Tough"};
   var Monster = F5(function (a,
   b,
   c,
   d,
   e) {
...
Elm.Util.make = function (_elm) {
   ...
   var isStun = function ($) {
      return F2(function (x,y) {
         return _U.eq(x,y);
      })($Types.Stun)(function (_) {
         return _.statusType;
      }($));
   };
   var origin = {ctor: "_Tuple2"
                ,_0: $Const.tileSize * ($Const.height / 2 - 0.5)
                ,_1: $Const.tileSize * ($Const.width / 2 * -1 + 0.5)};
   var flatten = function (l) {
      return A3($List.foldl,
      F2(function (subl,accl) {
         return A3($List.foldl,
         F2(function (x,y) {
            return A2($List._op["::"],
            x,
   ...
   var cond = F3(function (bool,
   a,
   b) {
      return bool ? a : b;
   });
   var bound = function (_v0) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
            return {ctor: "_Tuple2"
